...
class AdministradorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrador" do
    assert_difference('Administrador.count') do
      post administradors_url, params: { administrador: { contrasena: @administrador.contrasena, contrasenaC: @administrador.contrasenaC, email: @administrador.email, empresa: @administrador.empresa, nomAdmin: @administrador.nomAdmin, rfc: @administrador.rfc } }
    end
  ...
  test "should update administrador" do
    patch administrador_url(@administrador), params: { administrador: { contrasena: @administrador.contrasena, contrasenaC: @administrador.contrasenaC, email: @administrador.email, empresa: @administrador.empresa, nomAdmin: @administrador.nomAdmin, rfc: @administrador.rfc } }
