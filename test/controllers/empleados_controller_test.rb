...
class EmpleadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empleado" do
    assert_difference('Empleado.count') do
      post empleados_url, params: { empleado: { nomEmpleado: @empleado.nomEmpleado, puesto: @empleado.puesto, rfc: @empleado.rfc, sucursal: @empleado.sucursal } }
    end
  ...
  test "should update empleado" do
    patch empleado_url(@empleado), params: { empleado: { nomEmpleado: @empleado.nomEmpleado, puesto: @empleado.puesto, rfc: @empleado.rfc, sucursal: @empleado.sucursal } }
